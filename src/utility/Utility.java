...
public class Utility extends BaseTest {
    ...
    /**
     * This will assert when you pass on only part of text to verify if actual contains expected text
     * @param by
     * @param expectedContains
     */
    public void assertToVerifyTextContains(By by, String expectedContains){
        String actual = driver.findElement(by).getText();
        boolean outcome = actual.contains(expectedContains.trim());
